...
open class SearchTextField: UITextField {
    ...
    fileprivate func buildSearchTableView() {
        if let tableView = tableView, let shadowView = shadowView {
			...
			tableView?.register(SearchTextFieldItemCell.self, forCellReuseIdentifier: SearchTextField.cellIdentifier)
        }
    ...
    @objc open func textFieldDidChange() {
        ...
        timer?.invalidate()
        timer = Timer.scheduledTimer(timeInterval: stoppedTypingDelay, target: self, selector: #selector(SearchTextField.typingDidStop), userInfo: self, repeats: false)
...
extension SearchTextField: UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		guard let cell = tableView.dequeueReusableCell(withIdentifier: SearchTextField.cellIdentifier) as? SearchTextFieldItemCell else {
        ...
        cell.customImageView?.image = filteredResults[(indexPath as NSIndexPath).row].image
...
////////////////////////////////////////////////////////////////////////
// Cell with regular sized image view

public class SearchTextFieldItemCell: UITableViewCell {
	
	private(set) var customImageView: UIImageView?
	...
	private func commonInit() {
		...
		if let customImageView = customImageView {
			addSubview(customImageView)
			customImageView.contentMode = .scaleAspectFill
			customImageView.autoresizingMask = []
